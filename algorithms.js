function main(){
    ...
    console.log("Calling mySome and checking if the original array has an even number. Verdict: " + mySome(array, even));
    console.log('\n');

    console.log("Calling myEvery and checking if all the elements of the original array are even. Verdict: " + myEvery(array, even));
    console.log('\n');

    console.log("Calling myReduce on the original array. Result: " + myReduce(array, increment));
    console.log('\n');

    console.log("Calling myIncludes on the original array, checking if there is a 2 present. Result: " + myIncludes(array, 2));
    console.log('\n');
    ...
    console.log("Calling myIndexOf on 3. Index: " + myIndexOf(array, 3));
    console.log('\n');

    console.log("Calling myLastIndexOf on 3. Index: " + myLastIndexOf(array, 3));
    console.log('\n');
